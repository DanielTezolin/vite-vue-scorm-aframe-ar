...
function SCORM_Player(options) {
	...
	function loadScormContentOnIframe(callback) {
		...
		var iframe = $('<iframe id="scormcontent" style="width:100%; height:100%; border: none" webkitAllowFullScreen="true" allowfullscreen="true" mozallowfullscreen="true" allow="gyroscope; accelerometer"></iframe>');
